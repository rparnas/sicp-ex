...
variable "balance" is created as a parameter of
"make-withdraw". We could also create the local state
...
Recall from Section 1.3.2 that "let" is simply syntactic
...
of "make-withdraw", drawing figures like the ones above to
...
with the same behavior. How do the environment structures
