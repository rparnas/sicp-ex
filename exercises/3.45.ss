...
and withdrawals aren't automatically serialized. He suggests
that "make-account-and-serializer" should have exported the
serializer (for use by such procedures as
"serialized-exchange") in addition to (rather than instead
of) using it to serialize accounts and deposits as
"make-account" did. He proposes to redefine accounts as
follows:
