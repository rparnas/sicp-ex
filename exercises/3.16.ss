...
count the number of pairs in any list structure. "It's
easy," he reasons. "The number of pairs in any structure is
the number in the "car" plus the number in the "cdr" plus
one more to count the current pair." So Ben writes the
following procedure:
